...
// Generated from this Vector3.msg definition:
...
#ifndef YARPMSG_TYPE_Vector3
#define YARPMSG_TYPE_Vector3
...
public:
  ...
  typedef yarp::os::idl::BareStyle<Vector3> rosStyle;
  typedef yarp::os::idl::BottleStyle<Vector3> bottleStyle;
...
float64 z";
  ...
  yarp::os::Type getType() {
    yarp::os::Type typ = yarp::os::Type::byName("Vector3","Vector3");
